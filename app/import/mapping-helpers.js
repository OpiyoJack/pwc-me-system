...
const IMPORT_TARGETS = {
  beneficiaries: {
    ...
    fields: [
      ...
      { key: "project", label: "Project (match by name)", required: false, synonyms: ["project", "projectname", "programmename"], example: "Esiteti VSLA Microcredit Circles" },
  ...
  projects_indicators: {
    ...
    fields: [
      { key: "projectName", label: "Project name", required: true, synonyms: ["project", "projectname", "name"], example: "Naado Clean Water Access" },
  ...
  risks: {
    ...
    fields: [
      ...
      { key: "project", label: "Project (match by name)", required: false, synonyms: ["project", "projectname"], example: "Naado Clean Water Access" },
    ],
